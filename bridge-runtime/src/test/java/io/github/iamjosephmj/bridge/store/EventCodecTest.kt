    ...
    @Test fun `round-trips every event type`() {
        val events = listOf(
            WorkEvent.Enqueued("w1", 100L, workerName = "upload", generation = 1,
                ...
                deadlineMs = 999_000L),
            WorkEvent.Enqueued("w1", 100L, workerName = "watch", generation = 1,
                importance = 2, contentUris = listOf("content://media/photos", "content://media/videos"),
                contentDescendants = true, contentUpdateDelayMs = 500L, contentMaxDelayMs = 5_000L),
