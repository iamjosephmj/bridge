...
Measured on physical hardware. Identical workloads were run against both backends. Raw markdown tables, citable: [`docs/RESULTS.md`](docs/RESULTS.md); raw reports: [`bench/scripts/reports/`](bench/scripts/reports/).
